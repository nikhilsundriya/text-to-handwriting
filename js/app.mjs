 ...
 *
 * If you have any questions related to code, you can drop them in my Twitter DM @nikhil_sundriya
 * or in my email at nikhilchoudhary2508@gmail.com
 *
...
fetch(
  'https://api.github.com/repos/nikhilsundriya/text-to-handwriting/contributors'
)
  .then((res) => res.json())
  .then((res) => {
